      ...
      e.parseHtml = function (t, e, n, o, r) {
        ...
        for (var p = 0; p < s.rows.length; p++) {
          var g = s.rows[p],
            ...
            v = i(u, d, n, g, o, r);
          v &&
            ("thead" === y ? c.push(v) : "tfoot" === y ? f.push(v) : h.push(v));
        }
        ...
        var f = (function (t, e, n) {
          ...
          g = (function (t, e) {
            ...
            return {
              ...
              tableLineColor:
                null !== (h = e.tableLineColor) && void 0 !== h ? h : 200,
        ...
        if (n.canEntireRowFit(u, s)) h(t, e, n, l, s);
          ...
          (function (t, e, n, o) {
            var r = t.pageSize().height,
              ...
              l = r - (i.top + i.bottom);
            "body" === e.section &&
              (l -= o.getHeadHeight(o.columns) + o.getFootHeight(o.columns));
    ...
    function (t, e, n) {
      ...
      e.parseCss = function (t, e, n, i, l) {
        ...
        -1 !== c.indexOf(i.textAlign) && (a.halign = i.textAlign),
          -1 !== (c = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) &&
      ...
      var o = function (t, e, n) {
        ...
        for (
          var o = e.settings.margin,
            r = t.pageSize().width - (o.left + o.right),
            i = [],
            l = [],
            a = e.columns.length,
            s = n && n.start ? n.start : 0;
          s < a;
